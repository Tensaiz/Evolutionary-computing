...
for en in all_combos:
    ...
    # initializes simulation in individual evolution mode, for two static enemies.
    ...
    f = open(experiment_name+'/results_best_' + name_suffix + '_enemy_' + str(enemy_1) + str(enemy_2) + '.txt','a')
    f.write(str(hof[0]))
    f.close()
